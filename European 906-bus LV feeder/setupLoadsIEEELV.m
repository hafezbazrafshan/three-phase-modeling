function [ network ] = setupLoadsIEEELV( network )
...
%% 4. Setting up loads:
[loadBuses,loadTypes,Ph1,Ph2,Ph3,Ph4,Ph5,Ph6] = importloads([datapath,'/Loads.csv'], [datapath,'/exportloads.csv']);




sL=sparse(zeros(N*3,2));
yL=sparse(zeros(N*3,2));
iL=sparse(zeros(N*3,2));

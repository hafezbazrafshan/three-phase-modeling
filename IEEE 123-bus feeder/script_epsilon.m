...
network_nonIdealRegs=setupYbusIEEE123('non-ideal',1e-1);
...
ylim([-0.0005 max([a_err;b_err;c_err])+0.001]);
VerticalOffset = 0.0015;
ax=axis;
...
% xlabel(' $\epsilon$','FontName','Times New Roman','fontSize',14); 
t = text(xTicks(5)-0.4,ax(3)-0.003,' $\epsilon/|y_t|$');
s = t.FontSize;
t.FontSize = 20;
...
% 
cd('Figures'); 
print -dpdf IEEE123Epsilon.pdf
print -depsc2 IEEE123Epsilon

...
Yseries=inv(R+sqrt(-1)*X);
Yshunt=(sqrt(-1)*C*10^(-9));
else
Yseries= T* inv([r0+sqrt(-1)*x0 0 0; 0 r1+sqrt(-1)*x1 0; 0 0 r2+sqrt(-1)*x2])*inv(T);
Yshunt=sqrt(-1)*T * [c0 0 0; 0 c1 0; 0 0 c2]*inv(T)*10^(-9);

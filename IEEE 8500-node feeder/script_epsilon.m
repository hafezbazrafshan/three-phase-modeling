...
network_nonIdealRegs=setupYbusIEEE8500('non-ideal',1e-1);
...
ylim([-0.001 max([a_err;b_err;c_err])+0.004]);
...
t = text(xTicks(5)-0.4,ax(3)-0.012,' $\epsilon/|y_t|$');
s = t.FontSize;
t.FontSize = 20;
...
% 
cd('Figures'); 
print -dpdf IEEE8500Epsilon.pdf
print -depsc2 IEEE8500Epsilon
